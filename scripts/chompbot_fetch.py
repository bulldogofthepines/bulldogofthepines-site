...
<GetSellerListRequest xmlns="urn:ebay:apis:eBLBaseComponents">
        ...
        if "<?xml" in response.text or "<GetSellerListResponse" in response.text:
            ...
            for item in items:
                ...
                all_items.append({
                    ...
                    'description': f"Quality item from Bulldog of the Pines: {clean_title}. eBay Condition: {raw_ebay_condition}",
                    'link': f"https://bulldogofthepines.com/items/{item_id}.html",
    ...
    if all_items:
        ...
        df_master.to_csv(os.path.join(BASE_PATH, "data", "latest_inventory.csv"), index=False)
        ...
        df_google.to_csv(os.path.join(BASE_PATH, "data", "gmc_feed.csv"), index=False)
        ...
        with open(os.path.join(BASE_PATH, "data", "search_index.json"), "w", encoding="utf-8") as f:
