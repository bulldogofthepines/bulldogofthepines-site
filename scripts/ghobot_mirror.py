...
latest_csv = os.path.join(BASE_PATH, "data", "latest_inventory.csv")
output_html = os.path.join(BASE_PATH, "pages", "inventory-mirror.html")
...
def generate_ghost_mirror():
    ...
    <head>
        ...
        <link rel="canonical" href="https://bulldogofthepines.com/pages/inventory-mirror.html" />
        ...
        if not sub_df.empty:
            ...
            <a href="{aisle_filename}" style="text-decoration: none; color: #021F00;">
                <div style="background: white; border: 1px solid #ddd; border-radius: 8px; padding: 15px; text-align: center; height: 250px; display: flex; flex-direction: column; justify-content: space-between; align-items: center;">
                    <img src="../images/{img_file}" style="width: 100%; height: 160px; object-fit: contain; border-radius: 4px;">
